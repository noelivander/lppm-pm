...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('ALTER TABLE penelitians MODIFY COLUMN biaya_diusulkan TEXT');
    }
    ...
    public function down()
    {
        ...
        DB::statement('ALTER TABLE penelitians MODIFY COLUMN biaya_diusulkan DECIMAL(15, 2)');
    }
};
