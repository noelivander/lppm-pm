            ...
            <div class="col-md-12">
                <div class="mb-3 fade-in-up">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                        <div>
                            <h3 class="mb-1">
                                <i class="fa fa-chart-line me-2"></i>Laporan Akhir Penelitian
                            </h3>
                        </div>
                    </div>
                    ...
                    <form method="GET" class="modern-card p-3 mb-3 filter-card">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ route('penelitian-dos.laporan-akhir.index') }}" class="modern-btn modern-btn-outline w-100">
                                    Reset
                                </a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($proposals as $proposal)
                                        @php
                                            ...
                                            // Ensure we check correct relation or table
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                @if($hasLaporan)
                                                    <a href="{{ route('penelitian-dos.laporan-akhir.create', $proposal->id) }}" class="modern-btn modern-btn-warning modern-btn-sm">
                                                        <i class="fa fa-edit me-1"></i>Edit
                                                    </a>
                                                @else
                                                    <a href="{{ route('penelitian-dos.laporan-akhir.create', $proposal->id) }}" class="modern-btn modern-btn-primary modern-btn-sm">
                                                                        ...
                                                                        <div class="col-md-6 mb-3">
                                                                            <div class="modern-card">
                                                                                <div class="modern-card-body text-center">
                                                                                    ...
                                                                                    <a href="{{ route('penelitian-dos.laporan-akhir.view-reviews', ['penelitian_id' => $proposal->id, 'review_number' => $index + 1]) }}" 
