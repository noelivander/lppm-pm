            ...
            <div class="col-md-12">
                <div class="mb-3 fade-in-up">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                        <div>
                            <h3 class="mb-1">
                                <i class="fa fa-chart-line me-2"></i>Laporan Kemajuan Pengabdian
                            </h3>
                        </div>
                    </div>
                    ...
                    <form method="GET" class="modern-card p-3 mb-3 filter-card">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ route('pengabdian-dos.laporan-kemajuan.index') }}" class="modern-btn modern-btn-outline w-100">
                                    Reset
                                </a>
                            </div>
                        </div>
