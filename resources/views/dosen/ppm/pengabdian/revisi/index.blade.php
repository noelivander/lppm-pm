            ...
            <div class="col-md-12">
                <div class="mb-3 fade-in-up">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                        <div>
                            <h3 class="mb-1">
                                <i class="fa fa-hands-helping me-2"></i>Revisi Proposal Pengabdian
                            </h3>
                        </div>
                    ...
                    @if (!$timeline)
                        <div class="modern-alert modern-alert-danger">
                            <i class="fa fa-exclamation-circle me-2"></i>Belum ada timeline aktif untuk revisi proposal pengabdian.
                        </div>
                    @else
                    ...
                    <form method="GET" class="modern-card p-3 mb-3 filter-card">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ route('pengabdian-dos.revisi.index') }}" class="modern-btn modern-btn-outline w-100">
                                    Reset
                                </a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($revision && !$canEditRevision)
                                                    @php
                                                        $revisionReviews = \App\Models\Review::where('pengabdian_id', $revision->id)
                                                    ...
                                                    <div class="d-flex justify-content-center gap-2">
                                                        @if($revisionReviews->count())
                                                            <button type="button"
                                                                    ...
                                                                    data-bs-target="#lihatKomentarRevisiPengabdian{{ $revision->id }}">
                                                    ...
                                                    @if($revisionReviews->count())
                                                        ...
                                                        <div class="modal fade" id="lihatKomentarRevisiPengabdian{{ $revision->id }}" tabindex="-1" aria-hidden="true">
                                                    ...
                                                    @endif
                                                @else
                                                    <a href="{{ route('pengabdian-dos.revisi.create', $proposal->id) }}" class="modern-btn modern-btn-sm {{ $revision ? 'modern-btn-primary' : 'modern-btn-warning' }}">
