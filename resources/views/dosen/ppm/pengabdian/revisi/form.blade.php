            ...
            <div class="col-md-12">
                <div class="mb-3 fade-in-up">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                        <h3 class="mb-0"><i class="fa fa-sync-alt me-2"></i>Revisi Proposal Pengabdian</h3>
                        <a href="{{ route('pengabdian-dos.revisi.index') }}" class="modern-btn modern-btn-secondary">
                    ...
                    @if (!$timeline || !$timeline->revision_start_date || !$timeline->revision_end_date)
                        <div class="modern-alert modern-alert-danger">
                            <i class="fa fa-exclamation-circle me-2"></i>Belum ada jadwal revisi aktif. Form dinonaktifkan.
                        </div>
                    @else
                    ...
                    @if ($errors->any())
                        <div class="modern-alert modern-alert-danger">
                            <i class="fa fa-exclamation-circle me-2"></i>Kirim revisi gagal. Mohon periksa kembali:
                    ...
                    <div class="modern-card mt-4">
                        <div class="modern-card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                            <div>
                                <h4 class="mb-0"><i class="fa fa-file-alt me-2"></i>Form Revisi Pengabdian</h4>
                            </div>
                            @unless($uploadOpen)
                        ...
                        <form method="POST" action="{{ route('pengabdian-dos.revisi.store', $originalProposal->id ?? $proposal->id) }}" enctype="multipart/form-data" novalidate>
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="modern-form-group">
                                                ...
                                                <input type="text" name="judul" id="judul" class="modern-form-input" placeholder="Masukkan judul pengabdian..." value="{{ old('judul', $draft->judul ?? '') }}" required>
                                            </div>
                                            ...
                                            <div class="modern-form-group">
                                                ...
                                                <input type="text" name="lama_penelitian" id="lama_penelitian" class="modern-form-input" placeholder="Contoh: 6 bulan" value="{{ old('lama_penelitian', $draft->lama_penelitian ?? '') }}" required>
                                            </div>
                                            ...
                                            <div class="modern-form-group">
                                                ...
                                                <textarea name="ringkasan_proposal" id="ringkasan_proposal" class="modern-form-textarea" placeholder="Tuliskan ringkasan proposal pengabdian..." required>{{ old('ringkasan_proposal', $draft->ringkasan_proposal ?? '') }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="modern-form-group">
                                                ...
                                                <select name="skema" id="skema" class="modern-form-select" required>
                                                    <option value="" disabled {{ !old('skema', $draft->skema ?? '') ? 'selected' : '' }}>Pilih skema pengabdian...</option>
                                            ...
                                            <div class="modern-form-group">
                                                ...
                                                @else
                                                    <div class="modern-alert modern-alert-info mb-2">
                                                        <i class="fa fa-info-circle me-2"></i>Jika tidak ada perubahan dokumen, Anda boleh melewati unggah baru dan dokumen sebelumnya akan dipakai.
