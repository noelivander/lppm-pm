				...
				<div class="col-lg-8" data-aos="fade-up">
					<div class="mb-4">
						<span class="badge px-4 py-2"
							...
							<i class="fas fa-newspaper me-2"></i>Kabar Terkini
						</span>
					</div>
					...
					<p class="lead text-white mb-5" style="opacity: 0.9; line-height: 1.8; font-size: 1.1rem;">
						Dapatkan informasi terbaru seputar kegiatan, publikasi, dan pencapaian LPPM-PM Institut
									...
									<div class="col-lg-5">
										<div class="position-relative">
											...
											<input type="text" name="q" value="{{ $q ?? '' }}"
												...
												style="border-radius: 15px;" placeholder="Cari berita...">
										</div>
									</div>
				...
				<div class="text-center py-5">
					<div class="mb-4">
						<div class="d-inline-flex align-items-center justify-content-center"
							...
							<i class="fas fa-newspaper fa-3x" style="color: #4f46e5;"></i>
						</div>
					</div>
					<h4 class="fw-bold mb-2" style="color: #1e1b4b;">Belum ada berita</h4>
								...
								<div class="position-relative overflow-hidden" style="height: 220px;">
									...
									@else
										<div class="d-flex align-items-center justify-content-center w-100 h-100 bg-light">
											<i class="fas fa-image text-muted opacity-25" style="font-size: 4rem;"></i>
										</div>
									@endif
								...
								<div class="card-body p-4 d-flex flex-column">
									<div class="mb-3">
										<span class="text-uppercase fw-bold small"
											style="color: #4f46e5; letter-spacing: 0.5px;">Berita</span>
									</div>

									<h5 class="card-title fw-bold mb-3 line-clamp-2" style="color: #1e1b4b; line-height: 1.4;">
										<a href="{{ route('layanan-berita.show', ['slug' => $item->slug]) }}"
