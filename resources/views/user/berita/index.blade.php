		...
		<div class="container">
			<div class="row align-items-center g-4">
				<div class="col-lg-7 text-white">
					...
					<h1 class="display-5 fw-bold mb-3 text-white">Berita Terbaru</h1>
					<p class="mb-0 text-white" style="font-size: 1.1rem; opacity: 0.95;">Rangkaian informasi, kegiatan, dan publikasi terkini LPPM-PM ITH.</p>
				</div>
				<div class="col-lg-5">
						...
						<div class="row g-2 align-items-center">
							<div class="col-12 col-md">
								<div class="position-relative">
									...
									<input name="q" value="{{ $q ?? '' }}" class="form-control ps-5" placeholder="Cari berita..." aria-label="Cari berita">
								</div>
							</div>
				...
				<div class="col-xl-4 col-md-6">
					<article class="card h-100 border-0 shadow-sm" style="border-radius: 16px; overflow:hidden;">
						<div class="position-relative" style="height: 200px; background: #f3f4f6;">
							...
							@else
								<div class="d-flex align-items-center justify-content-center w-100 h-100"><i class="fas fa-image text-muted" style="font-size: 3rem;"></i></div>
							@endif
						...
						<div class="card-body">
							<h6 class="mb-2" style="line-height:1.5; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden;">{{ $item->judul }}</h6>
							...
							<div class="d-flex justify-content-between align-items-center">
								<a href="{{ route('layanan-berita.show', ['slug'=>$item->slug]) }}" class="btn btn-sm btn-primary"><i class="fas fa-book-open me-2"></i>Baca</a>
