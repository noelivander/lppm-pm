...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('auditor.dashboard') }}">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item @isroute('auditor.dashboard')">
        <a class="nav-link" href="{{ route('auditor.dashboard') }}">
