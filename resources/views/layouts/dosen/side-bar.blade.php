...
<ul class="navbar-nav sidebar sidebar-dark accordion d-flex flex-column sidebar-modern" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center" href="{{ route('dosen.dashboard') }}">
        ...
        <div class="sidebar-brand-text">LPPM-PM<div><small>Dosen</small></div>
        </div>
    </a>
    ...
    <li class="nav-item {{ $penelitianMenuActive ? 'active' : '' }}">
        ...
        <div id="collapsePenelitianDosen" class="collapse {{ $penelitianMenuActive ? 'show' : '' }}"
            data-bs-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item @isroute('penelitian-dos.index')"
                    href="{{ route('penelitian-dos.index') }}">Upload Proposal</a>
                <a class="collapse-item @isroute('penelitian-dos.revisi.index')"
                    href="{{ route('penelitian-dos.revisi.index') }}">Revisi Proposal</a>
                <a class="collapse-item" href="{{ route('penelitian-dos.laporan-kemajuan.index') }}">Laporan
                    Kemajuan</a>
                <a class="collapse-item @isroute('penelitian-dos.laporan-akhir.index')"
                    href="{{ route('penelitian-dos.laporan-akhir.index') }}">Laporan Akhir</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item {{ $pengabdianMenuActive ? 'active' : '' }}">
        ...
        <div id="collapsePengabdianDosen" class="collapse {{ $pengabdianMenuActive ? 'show' : '' }}"
            data-bs-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item @isroute('pengabdian-dos.index')"
                    href="{{ route('pengabdian-dos.index') }}">Upload Proposal</a>
                <a class="collapse-item @isroute('pengabdian-dos.revisi.index')"
                    href="{{ route('pengabdian-dos.revisi.index') }}">Revisi Proposal</a>
                <a class="collapse-item" href="{{ route('pengabdian-dos.laporan-kemajuan.index') }}">Laporan
                    Kemajuan</a>
                <a class="collapse-item @isroute('pengabdian-dos.laporan-akhir.index')"
                    href="{{ route('pengabdian-dos.laporan-akhir.index') }}">Laporan Akhir</a>
            </div>
        </div>
    </li>
