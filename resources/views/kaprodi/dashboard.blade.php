    ...
    <div class="container-fluid">
        ...
        {{-- <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <a href="{{ url('/kaprodi/ppm/penelitian-dos') }}" class="text-decoration-none w-100">
                    <x-kaprodi.dash-content-card title="Usulan Penelitian" value="{{ $jumlahPenelitian }}" color="info" class="w-100">
                        <i class="fas fa-microscope fa-2x text-gray-300"></i>
                    </x-kaprodi.dash-content-card>
                </a>
            </div>
        
            <!-- Pengabdian -->
            <div class="col-md-6 mb-3">
                <a href="{{ url('/kaprodi/ppm/pengabdian-dos') }}" class="text-decoration-none w-100">
                    <x-kaprodi.dash-content-card title="Usulan Pengabdian" value="{{ $jumlahPengabdian }}" color="warning" class="w-100">
