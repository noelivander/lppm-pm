                    ...
                    <div class="modern-card-body">
                        ...
                        <form action="{{ route('penelitian-adm.approve-reject', $proposal->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="admin_comment" name="admin_comment" class="modern-form-textarea" rows="4" placeholder="Masukkan komentar atau catatan untuk proposal ini..." @if(!$canMakeDecision) disabled @else required @endif>{{ $proposal->admin_comment ?? '' }}</textarea>
