                ...
                <div class="mb-3 fade-in-up">
                    ...
                    <form method="GET" class="modern-card p-3 mb-3 filter-card">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ route('penelitian-adm.index') }}" class="modern-btn modern-btn-outline w-100">
                                    Reset
                                </a>
                            </div>
                        </div>
                    ...
                    @if ($proposals->count() === 0)
                        <div class="modern-alert modern-alert-info">
                            <i class="fa fa-info-circle me-2"></i>Tidak ada proposal penelitian yang sudah direview lengkap.
                        </div>
                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($proposal->admin_status)
                                                    <a href="{{ route('penelitian-adm.show', $proposal->id) }}" class="modern-btn modern-btn-warning modern-btn-sm">
                                                        <i class="fa fa-edit me-1"></i> Edit
                                                    </a>
                                                @else
                                                    <a href="{{ route('penelitian-adm.show', $proposal->id) }}" class="modern-btn modern-btn-primary modern-btn-sm">
