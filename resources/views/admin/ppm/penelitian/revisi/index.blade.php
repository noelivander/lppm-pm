                    ...
                    <form method="GET" class="modern-card p-3 mb-3 filter-card">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ route('penelitian-adm.revisi.index') }}" class="modern-btn modern-btn-outline w-100">
                                    Reset
                                </a>
                            </div>
                        </div>
                                    ...
                                    @foreach ($proposals as $proposal)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('penelitian-adm.revisi.show', $proposal->id) }}" class="modern-btn modern-btn-primary modern-btn-sm">
