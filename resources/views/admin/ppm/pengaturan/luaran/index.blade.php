            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('luaran.edit', ['luaran'=>$value->id]) }}" role="button" class="btn btn-warning btn-sm text-white">Ubah</a>
                                <form method="POST" action="{{ route('luaran.destroy', $value->id) }}">
                                    @method('DELETE')
                                    @csrf
