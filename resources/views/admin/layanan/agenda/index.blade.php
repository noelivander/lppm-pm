                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        @if($value->is_shown)
                                        <a href="{{ route('layanan-agenda.show', ['slug'=>$value->slug]) }}" role="button" class="btn btn-success btn-sm ms-1 d-flex align-items-center text-white" target="_blank">Lihat</a>
                                        @endif
                                        <a href="{{ route('agenda.edit', ['agenda'=>$value->id]) }}" role="button" class="btn btn-warning btn-sm d-flex align-items-center ms-1 text-white">Ubah</a>
