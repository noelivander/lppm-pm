                        ...
                        <form method="GET" class="modern-card p-3 mb-3 filter-card">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-2 d-flex gap-2">
                                    ...
                                    <a href="{{ route('penelitian-rev.index') }}" class="modern-btn modern-btn-outline w-100">
                                        Reset
                                    </a>
                                </div>
                            </div>
                            ...
                            <tbody>
                                @foreach ($proposals as $proposal)
                                    @php
                                        ...
                                        $totalReviews = $existingReviews->where('penelitian_id', $proposal->id)->count();
                                                ...
                                                @if (in_array($proposal->id, $reviews))
                                                    ...
                                                    <a href="{{ route('penelitian-rev.view_pdf', $proposal->id) }}" 
                                                       class="modern-btn modern-btn-danger modern-btn-sm">
                                                        <i class="fa fa-file-download me-1"></i> PDF
                                                    </a>
                                                @else
                                                    @if($isFull)
