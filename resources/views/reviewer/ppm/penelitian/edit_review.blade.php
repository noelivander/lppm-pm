        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('penelitian-rev.index') }}" class="modern-btn modern-btn-secondary">
                ...
                <div class="modern-card mb-4 fade-in-up">
                    <div class="modern-card-body">
                        <form action="{{ route('penelitian-rev.updateReview', $review->id) }}" method="POST">
                            ...
                            <h3 class="mb-3"><i class="fa fa-clipboard-check me-2"></i>Formulir Penilaian Proposal Penelitian</h3>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column p-3 border rounded-3 h-100">
                                            <span class="text-muted text-uppercase small fw-semibold">Lama Penelitian</span>
                            ...
                            <div class="mb-4">
                                ...
                                @else
                                    <div class="modern-alert modern-alert-info">
                                        <i class="fa fa-info-circle me-2"></i>Belum ada data anggota peneliti.
                                    </div>
                                @endif
                            ...
                            // Call the function to initialize word count when editing a comment
                            window.onload = function() {
                                updateWordCount(); // Initialize word count when page loads
                            };
                            </script>
