            ...
            <div class="col-md-12">
                <div class="mb-3 fade-in-up">
                    <h3 class="mb-3 d-flex align-items-center gap-2">
                        ...
                        <span>Laporan Kemajuan Penelitian</span>
                    </h3>
                    ...
                    <form method="GET" class="modern-card p-3 mb-3 filter-card">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ route('penelitian-rev.laporan-kemajuan.index') }}" class="modern-btn modern-btn-outline w-100">Reset</a>
                            </div>
                        </div>
                    </form>
                    ...
                    @if ($proposals->isEmpty())
                        <div class="modern-alert modern-alert-info">
                            <i class="fa fa-inbox me-2"></i>Belum ada laporan kemajuan yang dapat Anda review saat ini.
                        </div>
                    @else
