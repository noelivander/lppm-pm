        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3 class="mb-0"><i class="fa fa-clipboard me-2"></i>Peninjauan Revisi Proposal</h3>
                    <a href="{{ route('penelitian-rev.revisi.index') }}" class="modern-btn modern-btn-secondary">
                ...
                <div class="modern-card mb-4 fade-in-up">
                    <div class="modern-card-body">
                        <form action="{{ route('penelitian-rev.revisi.submit', $proposal->id) }}" method="POST">
                            @csrf
