            ...
            <div class="col-md-12">
                <div class="mb-3 fade-in-up">
                    <h3 class="mb-3 d-flex align-items-center gap-2">
                        ...
                        <span>Laporan Akhir Penelitian</span>
                    </h3>
                    ...
                    <form method="GET" class="modern-card p-3 mb-3 filter-card">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ route('penelitian-rev.laporan-akhir.index') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @if($isMyCompleted)
                                                        <a href="{{ route('penelitian-rev.laporan-akhir.create', $proposal->id) }}"
                                                            class="modern-btn modern-btn-warning modern-btn-sm">
                                                            <i class="fa fa-edit me-1"></i> Edit
                                                        </a>
                                                        <a href="{{ route('penelitian-rev.laporan-akhir.pdf', $proposal->id) }}"
