<x-reviewer-layout>
    <x-slot name="header">
        {{ __('Tinjau Laporan Akhir Pengabdian') }}
    </x-slot>
            ...
            <div class="col-md-12">
                <div class="mb-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <h3 class="mb-0 d-flex align-items-center gap-2">
                        <i class="fa fa-eye"></i>
                        <span>Tinjau Laporan Akhir Pengabdian</span>
                    </h3>
                    <a href="{{ route('pengabdian-rev.laporan-akhir.index') }}" class="modern-btn modern-btn-secondary">
                ...
                @if(isset($formPengabdian) && $formPengabdian->count() > 0)
                    <form action="{{ route('pengabdian-rev.laporan-akhir.store', $proposal->id) }}" method="POST" class="mb-4">
                        @csrf
                            ...
                            <div class="modern-card-body">
                                                        ...
                                                        @foreach($komponen->subKomponen as $sub)
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <span class="status-badge nilai">{{ number_format($sub->skor, 2) }}</span>
                                                                </td>
                                                                <td style="text-align: center;">
                                ...
                                <div class="modern-form-group mt-3">
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        name="catatan_umum"
                                        placeholder="Catatan umum terkait laporan akhir..."
                ...
                @else
                    <div class="modern-alert modern-alert-info">
                        ...
                        Belum ada form penilaian laporan akhir pengabdian yang dikonfigurasi di admin.
                    </div>
                @endif
            </div>
        </div>
