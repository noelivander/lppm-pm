                ...
                <div class="mb-3 fade-in-up">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Proposal pengabdian yang sedang dalam tahap revisi dan perlu ditinjau.</p>
                        </div>
                    </div>
                    ...
                    <form method="GET" class="modern-card p-3 mb-3 filter-card">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ route('pengabdian-rev.revisi.index') }}" class="modern-btn modern-btn-outline w-100">
                                    Reset
                                </a>
                            </div>
                        </div>
                    ...
                    @if ($proposals->count() === 0)
                        <div class="modern-alert modern-alert-info">
                            <i class="fa fa-info-circle me-2"></i>Tidak ada proposal revisi pengabdian saat ini.
                        </div>
                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{ route('pengabdian-rev.review', $proposal->id) }}" class="modern-btn modern-btn-primary modern-btn-sm">
